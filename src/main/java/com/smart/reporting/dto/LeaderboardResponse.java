...
public class LeaderboardResponse {
    ...
    private Integer rankCat;
    private Integer rankMix;
    ...
    public Integer getRankCat() {
        return rankCat;
    }

    public void setRankCat(Integer rankCat) {
        this.rankCat = rankCat;
    }

    public Integer getRankMix() {
        return rankMix;
    }

    public void setRankMix(Integer rankMix) {
        this.rankMix = rankMix;
    }

    public Integer getRankTot() {
        return rankTot;
    }

    public void setRankTot(Integer rankTot) {
        this.rankTot = rankTot;
    }
