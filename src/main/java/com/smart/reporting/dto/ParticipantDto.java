...
public class ParticipantDto {
    ...
    public ParticipantDto(String cplist,String name, String bib, String category, String eventId, String eventName, String cat, int rank1cat, int rank1mix, int rank1tot, String timeStart, String timeFinish,
            ...
            , Boolean dq, Boolean dns, Boolean dnf, Boolean nr, Boolean fs, Boolean nsbf, String remark) {
        this.cplist = cplist;
        this.name = name;
        this.bib = bib;
    ...
    public Boolean getNsbf() {
        return nsbf;
    }
    public void setNsbf(Boolean nsbf) {
        this.nsbf = nsbf;
    }
